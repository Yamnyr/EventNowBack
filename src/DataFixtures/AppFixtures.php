...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $evenementsData = [
            ['type' => $this->getReference('type_concert'), 'nom' => 'Concert Rock', 'description' => 'Description du concert rock', 'lieu' => 'Lieu du concert', 'annule' => false, 'raison_annulation' => null, 'age_requis' => 18, 'image' => 'https:/via.placeholder.com/320x240'],
        ];
